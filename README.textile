...
locus_tree.bulk_load('data_with_values.gff')
...
...or you can create the tree, save it and load it afterwards.
<pre>
require 'locus_tree'
locus_tree = LocusTree.new(2,3)
locus_tree.bulk_load('data_with_values.gff')
locus_tree.store('data_with_values.store')

#and later:
locus_tree = LocusTree.load('data_with_values.store')
</pre>
