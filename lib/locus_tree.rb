...
if __FILE__ == $0
  ...
  container = LocusTree::Container.create_structure(bin_size, nr_children, 'minimal_example.bed')

#  bin_size = 4000
#  nr_children = 2
#
#  container = LocusTree::Container.create_structure(bin_size, nr_children, 'genes_head.txt.sorted')
